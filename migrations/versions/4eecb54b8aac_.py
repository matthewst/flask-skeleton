...
def upgrade():
    ...
    sa.Column('Matej', sa.String(), nullable=False),
    sa.Column('Stuchlik', sa.String(), nullable=False),
    ...
    op.create_index('ix_loguser_Stuchlik', 'loguser', ['Stuchlik'], unique=False)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('karty')
    op.drop_index('ix_loguser_Stuchlik', table_name='loguser')
